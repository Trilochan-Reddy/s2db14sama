...
router.get('/', function(req, res) {
  res.render('index', { title: 'petshop Items App', user:req.user });
});

router.get('/register', function(req, res) {
  res.render('register', { title: 'petshop Items App Registration'});
  });
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'petshop App Login', user : req.user });
});
